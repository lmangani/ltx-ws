...
DEFAULT_STAGE1_STEPS_FAST = 20
DEFAULT_VIDEO_CFG = 3.0
DEFAULT_AUDIO_CFG = 7.0
# STG + AV-bimodal are required for face/character temporal coherence after frame 0
# (upstream ID-LoRA defaults). Disabling them makes identity drift after the I2V anchor.
